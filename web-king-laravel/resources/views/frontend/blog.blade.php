						...
						<div class="row">
								...
								<div class="single-blog">
									<div class="blog-img">
										<a href="blog-post.html">
											<img src="{{ asset('front/img/blog01.jpg') }}" alt="">
										</a>
									</div>
							...
							<div class="col-md-6">
								<div class="single-blog">
									<div class="blog-img">
										<a href="blog-post.html">
											<img src="{{ asset('front/img/blog02.jpg') }}" alt="">
										</a>
									</div>
									<h4><a href="blog-post.html">Pro eu error molestie deserunt. At per viderer bonorum persecuti.</a></h4>
									<div class="blog-meta">
							...
							<div class="col-md-6">
								<div class="single-blog">
									<div class="blog-img">
										<a href="blog-post.html">
											<img src="{{ asset('front/img/blog03.jpg') }}" alt="">
										</a>
									</div>
									<h4><a href="blog-post.html">Pro eu error molestie deserunt. At per viderer bonorum persecuti.</a></h4>
									<div class="blog-meta">
							...
							<div class="col-md-6">
								<div class="single-blog">
									<div class="blog-img">
										<a href="blog-post.html">
											<img src="{{ asset('front/img/blog04.jpg') }}" alt="">
										</a>
									</div>
									<h4><a href="blog-post.html">Pro eu error molestie deserunt. At per viderer bonorum persecuti.</a></h4>
									<div class="blog-meta">
						...
						<div class="widget posts-widget">
							...
							<div class="single-post">
								<a class="single-post-img" href="blog-post.html">
									<img src="{{ asset('fron/img/post01.jpg') }}" alt="">
								</a>
							...
							<div class="single-post">
								<a class="single-post-img" href="blog-post.html">
									<img src="{{ asset('fron/img/post02.jpg') }}" alt="">
								</a>
								<a href="blog-post.html">Pro eu error molestie deserunt.</a>
								<p><small>By : John Doe .18 Oct, 2017</small></p>
							</div>
							...
							<div class="single-post">
								<a class="single-post-img" href="blog-post.html">
									<img src="{{ asset('front/img/post03.jpg')}}" alt="">
								</a>
								<a href="blog-post.html">Pro eu error molestie deserunt.</a>
								<p><small>By : John Doe .18 Oct, 2017</small></p>
							</div>
