...
@section ('content')
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url({{ asset('front/img/home-background.jpg') }})"></div>
			<!-- /Backgound Image -->
		...
		<div id="about" class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="about-img">
							<img src="{{ asset('front/img/about.png') }}" alt="">
						</div>
					</div>
				...
				<div id="courses-wrapper">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{ asset('front/img/course01.jpg') }}" alt="">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{ asset('front/img/course02.jpg') }}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{ asset('front/img/course03.jpg') }}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{ asset('front/img/course04.jpg') }}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{ asset('front/img/course05.jpg') }}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{ asset('front/img/course06.jpg') }}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{ asset('front/img/course07.jpg') }}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="{{ asset('front/img/course08.jpg') }}" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
		...
		<div id="cta" class="section">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url({{ asset('front/img/cta1-background.jpg') }})"></div>
			<!-- /Backgound Image -->
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						<a class="about-video" href="#">
							<img src="{{ asset('front/img/about-video.jpg') }}" alt="">
		...
		<div id="contact-cta" class="section">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url({{ asset('front/img/cta2-background.jpg') }})"></div>
			<!-- Backgound Image -->
